  ...
  <header class="w3-container w3-center">
      <img class="logo"src="img/logo.png">
        ...
        <div class="bar w3-bar w3-light-blue w3-border w3-large ">
                ...
                <a href="cart.php" class="w3-bar-item w3-button rounded w3-hover-blue"><img src="icons/check-order-status.svg"><b> Cart</b></img></a>
              ...
              <div class="container">
                                <div style="padding:50px">
                                        ...
                                        <div class="ccard w3-card">
                                          ...
                                          <img class="rounded"src="img/11.jpg" alt="Car" style="width:100%;height:500px">
